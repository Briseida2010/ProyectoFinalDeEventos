...
public class frmBuscarPersona extends javax.swing.JInternalFrame {
    ...
    public frmBuscarPersona(IFormulario frmFormulario,int idEvento) {
        initComponents();
    ...
    public void cargarTabla(String busqueda){
        listaPersonas = clsInscripcion.listarPersonaNoInscritas(busqueda,idEvento);
