 ...
 * @author BEPIS
 */
public class FrmConsultaPrograma extends javax.swing.JInternalFrame {
     ...
     */
    public FrmConsultaPrograma() {
        initComponents();
        cargarTabla();
    }

    public void cargarTabla(){
        String titulos[] = {"idEvento","idPersona","tema","fechaInicio","fechaFinal"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Programa");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 104, 672, 130));
    ...
    clsPrograma programa = new clsPrograma();
    try{
        rs = programa.consultarPrograma();
