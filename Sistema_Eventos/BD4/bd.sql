...
쿠াҰ  80  쿠াҰ  0   쿠াҰ  1 us쿠াҰ  2 ;쿠াҰ  3 D;쿠াҰ  4 EF쿠াҰ  0 `@쿠াҰ  11  쿠াҰ  1 `s쿠াҰ  2 on쿠াҰ  3 pi쿠াҰ  4 t쿠াꆨ}  ᴬ@괜~  쿠াҰ  1 D 쿠াӤ  彀汬畭l쿠াꆨ}  ᴬ@괜~  쿠াꆨ}  ᴬ@괜~  쿠াꆨ}  ᴬ@괜~  nomb訶 䔸䔸秐ি  D䔸im䌐ি磰Qℰϟ녬Ӷ               魰I鮀IℰϟՈR䌰িÎ ɪ ^      ĀĀ  ँ䳀Ҥ  ＀쏐Ҥ몘Ҥ ￴    ￱￿               逬V초Ҥ                                                譬vℰϟ                                            洄ਈ  ý ɪ ý ɹ е ʎ Î ǅ ^       ȏ    Ҥ⁀Ϣ                 ā Ā                                                      ੌ4                ￿￿    ￿￿  㑠Ϧ￿￿쀐Ҥ      ￿￿￿￿  ￿￿      : Access䌐ি磰Qℰϟ롌Ҥ               魰I鮀IℰϟՈR䘐িi ɪ ^      ĀĀ  ँ䨠Ҥ  ＀쉀ҤҤ ￴    ￱￿               逬V볈Ҥ                                                譌vℰϟ                                            �ҝ   ɪ  ɹ е ʎ i ǅ ^       ȏ    Ҥ῀Ϣ                 ā Ā                                                      ਿ4                  ￿￿    ￿￿  往Ϧ￿￿읨Ҥ      ￿￿￿￿  ￿￿      Error de䌐ি磰Qℰϟ뉌Ӷ               魰I鮀IℰϟՈR䣰ি ɪ ^      Āā  ँ䴠Ҥ  ＀㊀ӵ崀ӵ ￴    ￱￿               逬V䁨ӵ                                                ﰠvℰϟ                                            洜ਈ  3 ɪ 3 ɹ е ʎ  ǅ ^       ȏ    ㄘӵ눀Ӷ                 ā Ā                                                      ਲ4                  ￿￿    ￿￿  㛐Ϧ￿￿㋸ӵ      ￿￿￿￿  ￿￿      htrdev, 䌐ি⽔Qℰϟ芤Ϩ               魰I鮀I�ȧ�N䯐িx  ά  ʨ  Āā   ܁쐐Ү  ＀뵨ϧ在Ϩ ￴    ￱￿              逬V픀ϧ                                                                                                紼ਈ  ά  Ɏ  Х s x  ǖ       ȏ    품ϧ䃰Ҭ                 ā Ā                                                      ণ4          @  Āā    긴vℰϟ￿￿￿￿  毬ʷ  鰈ȡ          2" */
/* Loadin䌐ি㽠QℰϟཔϨ               魰I鮀I�ȧ�N亰িx & ά H ¨  Āā   ༁빀Ү  ＀殠Ϩ䀈Ϩ ￴    ￱￿               逬Vꈐϧ                                                                                                    ά H Ɏ J Х s x & ά H      ȏ    㹐Ϩ䦰Ҭ                ā Ā                                                  ⒖潀૾_খ4          <   ā Ā  긴vℰϟ  ￿￿    ꅐϡĂ          2
...
A BLOB column with a maximum length of 4,294,967,295 or 4GB (232 - 1) bytes. The effective maximum length of LONGBLOB columns depends on the configured maximum packet size in the client/server protocol and available memory. Each LONGBLOB value is stored using a four-byte length prefix that indicates the number of bytes in the value.  PRIMARY KEY (`䌐িҰ ő CREATE TABLE `evento` (
  ...
  `titulo` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idEvento`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 LT CHARSET=latin1  KEY盱িҰ  ť   KEY `fk_Programa_Ponente1_idx` (`idPersona`),
  CONSTRAINT `fk_Programa_Evento1` FOREIGN KEY (`idEvento`) REFERENCES `evento` (`idEvento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Programa_Ponente1` FOREIGN KEY (`idPersona`) REFERENCES `ponente` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 EA䌐িҰ ŗ CREATE TABLE `ponente` (
  `idPersona` int(11) NOT NULL,
  `celular` varchar(45) DEFAULT NULL,
  `gradoAcademico` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idPersona`),
  CONSTRAINT `fk_Ponente_Persona1` FOREIGN KEY (`idPersona`) REFERENCES `persona` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 REIGN KEY (`idEv ﷩  Û ⨯㐡㄰㄰匠呅匠䱑䵟䑏㵅䙉啎䱌䀨䱏彄兓彌位䕄‬✧ ⼪഻⼊K〴㄰‴䕓⁔但䕒䝉彎䕋彙䡃䍅卋䤽⡆佀䑌䙟剏䥅乇䭟奅䍟䕈䭃⁓卉丠䱕ⱌㄠ‬佀䑌䙟剏䥅乇䭟奅䍟䕈䭃⥓⨠㬯਍⨯㐡㄰㄰匠呅䌠䅈䅒呃剅卟呅䍟䥌久㵔佀䑌䍟䅈䅒呃剅卟呅䍟䥌久⁔⼪഻
server version for the right syntax to use near '' at line 1 */ ACTION,
  CONSTRAINT `fk_Programa_Ponente1` FOREIGN KEY (`idPersona`) REFERENCES `ponente` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE= nnoDB DEFAULT CHA SET=latin1 BL焱ি﷩  ç 䕄䥌䥍䕔⁒⼯਍剃䅅䕔䐠䙅义剅怽潲瑯䁠池捯污潨瑳⁠剐䍏䑅剕⁅獠彰彄潃業楳湯⡠਍उ楰偤牥潳慮椠瑮ㄨ⤰ബऊ瀉摩癅湥潴椠瑮ㄨ⤰਍⤉਍䕂䥇ൎऊ䐉䱅呅⁅剆䵏䌠浯獩潩⁮䡗剅⁅摩敐獲湯⁡‽楰偤牥潳慮䄠䑎椠䕤敶瑮⁯‽楰䕤敶瑮㭯਍䔉䑎⼯਍䕄䥌䥍䕔⁒഻
ES `evento` (`idEvento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Programa_Ponente1` FOREIGN KEY (`idPersona`) REFERENCES `ponente` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHA SET=latin1 5'),
	(21, 1, 'Pagado', 50.00, '2014-05-04 21:05:46'),
	(22, 1, 'Pagado', 50.00, '2014-05-04 21:05:48');
/*!40000 ALTER TABLE `inscripcion` ENABLE KEYS */;
-- Volcando estructura para tabla db_eventos.persona
...
쵀িҰ  latin7_estonian_cs A쵀িҰ  latin7_general_ci ma쵀িҰ  latin7_general_cs _N쵀িҰ  cp1251_bulgarian_ci 쵀িҰ  cp1251_ukrainian_ci 쵀িҰ  cp1251_general_ci RE쵀িҰ  cp1251_general_cs PR쵀িҰ  cp1256_general_ci 'd쵀িҰ  cp1257_general_ci  F쵀িҰ  geostd8_general_ci N쵀িҰ  cp932_japanese_ci  `쵀িҰ  eucjpms_japanese_ci 쵀িҰ  SSL habilitado=No   쵀ি\bCOMMENT='((.+)[^'])' GIN쵀িҰ  Consultas lentas=0  쵀িҰ  SSL habilitado=No   쵀িҰ  Tablas abiertas=16  쵀িҰ  Consultas lentas=0  쵀িҰ  koi8r_general_ci    쵀িҰ  sp_PersonasxEvento  쵀িҰ  sp_D_Inscripcion .  쵀িҰ  sp_S_GastoEvento    쵀িҰ  SSL habilitado=No   쵀িҰ  Consultas lentas=0  쵀িҰ  sp_S_Inscripcion    쵀িҰ  Tablas abiertas=4   쵀িҰ  sp_S_ProgramaEvento 쵀িҰ  sp_S_UsuarioEvento i쵀িҰ  sp_U_Inscripcion T *쵀িҰ  usp_S_inscripcion 		쵀ি   ₁2   ȭ麀Ϫᤐী    D  ৆쵀িҰ  sp_I_Inscripcion +) 쵀িҰ  sp_PersonasxEvento  쵀িҰ  sp_S_ComisionEvento 쵀িҰ  sp_S_GastoEvento IST쵀িҰ  sp_S_Inscripcion na`쵀িҰ  sp_S_ProgramaEvento 쵀িҰ  sp_S_UsuarioEvento L쵀িҰ  sp_U_Inscripcion 5) 쵀িҰ  usp_S_inscripcion rI쵀ি榔_ ᴬ@満ϱ      ﭤ»  梈_梤_梸_  쵀িҰ  cp1251_general_cs   쵀িҰ  sp_PersonasxEvento  쵀িSELECT * FROM Inscripcion 쵀ি   ₁2   ȭᘀীᦸী    5 Š৆쵀িҰ  SSL habilitado=No   쵀িҰ  Consultas lentas=0  쵀ি   ₁2   ȭᤐীᨨী    - Ƞ৆쵀িҰ  Tablas abiertas=16  쵀ি   ₁2   ȭᦸী᩠ী    O ˠ৆쵀ি   ₁2   ȭᨨী᪘ী    = Π৆쵀ি   ₁2   ȭ᩠ী᫐ী    ? Ѡ৆쵀ি   ₁2   ȭ᪘ীᬈী    J ᷠ৆쵀ি   ₁2   ȭ᫐ীᭀী    l ৅쵀ি	   ₁2   ȭᬈী᭸ী    l ৅쵀ি
   ₁2   ȭᭀী᮰ী    [ ৅쵀ি   ₁2   ȭ᭸ীᯨী    T ৅쵀ি   ₁2   ȭ᮰ীᰠী    u ৅쵀ি   ₁2   ȭᯨী᱘ী    b ৅쵀ি   ₁2   ȭᰠীᲐী    d ৅쵀ি   ₁2   ȭ᱘ী᳈ী    o ৅쵀ি   ₁2   ȭᲐীᴀী    ` ৅쵀ি   ₁2   ȭ᳈ীᴸী    e ৅쵀ি   ₁2   ȭᴀীᵰী    e ৅쵀ি   ₁2   ȭᴸীᶨী    T ৅쵀ি   ₁2   ȭᵰীᷠী    M ৅쵀ি   ₁2   ȭᶨীḘী    n ৅쵀ি   ₁2   ȭᷠীṐী    [ 鸞৅쵀ি   ₁2   ȭḘীẈী    ] 易৅쵀ি   ₁2   ȭṐীỀী    h 猪৅쵀ি   2   ȭẈীỸী      ﭠ৅쵀ি   2   ȭỀীἰী      ﰠ৅쵀ি   2   ȭỸীὨী      ﳠ৅쵀ি   2   ȭἰীᾠী      ﶠ৅쵀ি   2   ȭὨীῘী      ﹠৅쵀ি   2   ȭᾠী‐ী      ࣠৆쵀ি   2   ȭῘী⁈ী      ঠ৆쵀ি    2   ȭ‐ী₀ী      ੠৆쵀ি!   2   ȭ⁈ী₸ী      ଠ৆쵀ি"   2   ȭ₀ী⃰ী      ௠৆쵀ি#   2   ȭ₸ীℨী      ಠ৆쵀ি$   2   ȭ⃰ীⅠী      찠৅쵀ি%   2   ȭℨী↘ী      ᫠৆쵀ি&   2   ȭⅠী⇐ী      Ⲡষ쵀ি'   2   ȭ↘ী∈ী      ⦠ষ쵀ি(   2   ȭ⇐ী≀ী      ᆠষ쵀ি)   2   ȭ∈ী≸ী      ૠষ쵀ি*   2   ȭ≀ী⊰ী      ֠ষ쵀ি+   2   ȭ≸ী⋨ী      ͠ষ쵀ি,   2   ȭ⊰ী⌠ী      ︠শ쵀ি-   2   ȭ⋨ী⍘ী      褐শ쵀ি.   2   ȭ⌠ী⎐ী      ﻠশ쵀ি/   2   ȭ⍘ী⏈ী      ܠষ쵀ি0   2   ȭ⎐ী␀ী      ࢠষ쵀ি1   2   ȭ⏈ী␸ী      ഠষ쵀ি2   2   ȭ␀ী⑰ী      ①ষ쵀ি3   2   ȭ␸ী⒨ী      ⎠ষ쵀ি4   2   ȭ⑰ীⓠী      ⸠ষ쵀ি5   2   ȭ⒨ী⚠ী      㙠ষ쵀িҰ  &Vaciar tabla(s)... 쵀িҰ  &Rutina almacenada  쵀ি榔_ ᴬ@ࠐϱ      ﭤ»  梈_梤_梸_  쵀ি   ₁2   폰ি闸Ϫ☰ী    T ﭠ৅쵀িҰ  SSL habilitado=No   쵀ি   ₁2   폰ি◀ী㐰ী     猪৅쵀িҰ  sp_S_PonenteEvento  쵀ি6   2   ȭⓠী        푠৅쵀িҰ  Consultas lentas=0  쵀িҰ  Tablas abiertas=16  쵀িҰ  cp1251_bulgarian_ci 쵀ি   ⃁2   唀ী存ী宐ী    _   쵀ি   á2  ~ 満ϱ➸ী➸ী흰ি咐ী  ) 쵀ি榔_ ᴬ@ϰ      ﭤ»  梈_梤_梸_  쵀ি   ₁2   폰ি횐ি꣠ҡ    Y ৅쵀ি   á2  Ħ ϰ⡠ী⡠ী⢘ী刨ী  ) 쵀ি    ₁2   ⡠ী  ⣐ী       쵀ি   ₁2   ⡠ী⢘ী⤈ী      쵀ি   ₁2   ⡠ী⣐ী⥀ী      쵀ি   ₁2   ⡠ী⤈ী⥸ী      쵀ি   ₁2   ⡠ী⥀ী⦰ী      쵀ি   ₁2   ⡠ী⥸ী儐ী      쵀িҰ  sp_S_ComisionEvento 쵀ি孠L  ⑐I              嫐L    쵀িҰ  sp_U_Inscripcion    쵀িҰ  sp_D_Inscripcion .  쵀িҰ  sp_I_Inscripcion +) 쵀িҰ  sp_S_GastoEvento  
	쵀িҰ  sp_S_Inscripcion son쵀িҰ  sp_S_PersonaEvento o쵀িҰ  sp_S_ProgramaEvento 쵀িҰ  sp_S_UsuarioEvento s쵀িҰ  sp_U_Inscripcion TE 쵀িҰ  usp_S_inscripcion  P쵀িҰ  sp_PersonasxEvento  쵀িҰ  latin1_german1_ci ) 쵀িҰ  sp_S_PersonaEvento `쵀িҰ  sp_S_GastoEvento r` 쵀িҰ  usp_S_inscripcion   쵀ি(;\s*)?InnoDB\s*free\:.*$ 쵀ি(;\s*)?InnoDB\s*free\:.*$ 쵀ি   ₁2   폰ি퇀ি廘ী    [ ৅쵀ি   ⃁2   唀ী媰ী혠ি       쵀ি   ₁2   폰িি⼨ী    T ৅쵀ি(;\s*)?InnoDB\s*free\:.*$ 쵀িҰ  sp_PersonasxEvento  쵀ি   ₁2   폰ি⺀ী퇀ি    M ৅쵀িҰ  sp_S_UsuarioEvento t쵀িҰ  usp_S_inscripcion  =쵀িҰ  cp1251_general_ci   쵀িҰ  sp_S_Inscripcion e d쵀িҰ  sp_I_Inscripcion +) 쵀িҰ  latin1_general_ci E 쵀ি(;\s*)?InnoDB\s*free\:.*$ 쵀িҰ  latin1_german2_ci E 쵀িҰ  cp850_general_ci n  쵀িҰ  sp_D_Inscripcion . l쵀িҰ  sp_I_Inscripcion +) 쵀িҰ  sp_S_ProgramaEvento 쵀িҰ  sp_D_Inscripcion .  쵀িҰ  sp_D_Inscripcion .  쵀িҰ  sp_S_ComisionEvento 쵀িҰ  sp_PersonasxEvento  쵀িҰ  sp_S_PersonaEvento  쵀িҰ  latin1_swedish_ci   쵀িҰ  sp_S_Inscripcion o  쵀িҰ  sp_S_ProgramaEvento 쵀িҰ  sp_U_Inscripcion T  쵀িҰ  sp_S_UsuarioEvento  쵀ি   ₁2   폰ি☰ীি    b 易৅쵀িҰ  sp_I_Inscripcion +) 쵀িҰ  sp_S_GastoEvento ri 쵀িҰ  sp_S_Inscripcion    쵀িҰ  sp_S_UsuarioEvento  쵀িҰ  sp_U_Inscripcion :  쵀িҰ  usp_S_inscripcion  
